...
public class Inbound implements java.io.Serializable{
	...
	//document 테이블 컬럼
		...
		public Inbound(String documentId, String documentTypeId, String clientId, String documentWriterId,
				...
				String companyPhone, String fax, String address, String url, String clientStatus,
		...
		public String toString() {
			return "Inbound [documentId=" + documentId + ", documentTypeId=" + documentTypeId + ", clientId=" + clientId
					...
					+ ", paymentMethod=" + paymentMethod + ", itemId=" + itemId + ", productId=" + productId
					+ ", quantity=" + quantity + ", documentName=" + documentName + ", transactionType="
					+ transactionType + ", clientName=" + clientName + ", ceoName=" + ceoName + ", businessNumber="
					+ businessNumber + ", categoryId=" + categoryId + ", companyPhone=" + companyPhone + ", fax=" + fax
					+ ", address=" + address + ", url=" + url + ", clientStatus=" + clientStatus
					+ ", contractStartDate=" + contractStartDate + ", contractEndDate=" + contractEndDate
					+ ", firstManagerId=" + firstManagerId + ", currentManagerId=" + currentManagerId
					+ ", directorName=" + directorName + ", directorPhone=" + directorPhone + ", email=" + email
					+ ", approveId=" + approveId + ", empId=" + empId + ", approver1Id=" + approver1Id
