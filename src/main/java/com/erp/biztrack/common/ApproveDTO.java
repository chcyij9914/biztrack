...
public class ApproveDTO implements java.io.Serializable {
	...
	private String secondApproverDeptName;
	private String firstApproverDeptName;
	private String firstApproverJobTitle;
	private String secondApproverJobTitle;
	...
	public ApproveDTO(String approveId, String documentId, String empId, String firstApproverId, Date firstApproveDate,
			...
			String secondApproverRoleName, String secondApproverDeptName, String firstApproverDeptName,
			String firstApproverJobTitle, String secondApproverJobTitle) {
		super();
		...
		this.secondApproverDeptName = secondApproverDeptName;
		this.firstApproverDeptName = firstApproverDeptName;
		this.firstApproverJobTitle = firstApproverJobTitle;
		this.secondApproverJobTitle = secondApproverJobTitle;
	}
	...
	public String getSecondApproverDeptName() {
		return secondApproverDeptName;
	}

	public void setSecondApproverDeptName(String secondApproverDeptName) {
		this.secondApproverDeptName = secondApproverDeptName;
	}

	public String getFirstApproverDeptName() {
		return firstApproverDeptName;
	}

	public void setFirstApproverDeptName(String firstApproverDeptName) {
		this.firstApproverDeptName = firstApproverDeptName;
	}

	public String getFirstApproverJobTitle() {
		return firstApproverJobTitle;
	}

	public void setFirstApproverJobTitle(String firstApproverJobTitle) {
		this.firstApproverJobTitle = firstApproverJobTitle;
	}

	public String getSecondApproverJobTitle() {
		return secondApproverJobTitle;
	}

	public void setSecondApproverJobTitle(String secondApproverJobTitle) {
		this.secondApproverJobTitle = secondApproverJobTitle;
	}
	...
	public String toString() {
		return "ApproveDTO [approveId=" + approveId + ", documentId=" + documentId + ", empId=" + empId
				...
				+ ", documentTitle=" + documentTitle + ", firstApproverName=" + firstApproverName
				+ ", secondApproverName=" + secondApproverName + ", firstApproverRoleName=" + firstApproverRoleName
				+ ", secondApproverRoleName=" + secondApproverRoleName + ", secondApproverDeptName="
				+ secondApproverDeptName + ", firstApproverDeptName=" + firstApproverDeptName
				+ ", firstApproverJobTitle=" + firstApproverJobTitle + ", secondApproverJobTitle="
				+ secondApproverJobTitle + "]";
	}
}
