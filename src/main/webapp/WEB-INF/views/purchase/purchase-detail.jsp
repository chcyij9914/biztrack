				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
							...
							<table class="table table-bordered text-center">
								...
								<tbody>
									...
									<tr class="bg-light font-weight-bold">
										...
										<td><fmt:formatNumber value="${document.totalAmount}"
												pattern="#,##0" />원</td>
									</tr>
								</tbody>
							</table>
			          ...
			          || loginInfo.empId == document.documentManagerId && approval.firstApproveStatus == '결재 대기'}">
									<a
										href="${pageContext.request.contextPath}/purchase/purchase-update.do?documentId=${document.documentId}"
								...
								<script>
									function confirmDelete(documentId) {
										if (confirm("정말 이 문서를 삭제하시겠습니까? 삭제 후 복구할 수 없습니다.")) {
											location.href = '${pageContext.request.contextPath}/purchase/documentDelete.do?documentId='
													+ documentId;
										}
									}
								</script>
