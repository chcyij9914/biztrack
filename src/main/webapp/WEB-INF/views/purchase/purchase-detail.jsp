...
<table class="table table-bordered text-center">
    ...
    <tbody>
        ...
        <div class="text-right mt-4">
	        <a href="${pageContext.request.contextPath}/purchase/purchase-update.do?documentId=${document.documentId}" 
            ...
            <a href="${pageContext.request.contextPath}/purchase/purchase-document.do" class="btn btn-info">
			...
			function confirmDelete(documentId) {
			  if (confirm("정말 이 문서를 삭제하시겠습니까? 삭제 후 복구할 수 없습니다.")) {
			    location.href = '${pageContext.request.contextPath}/purchase/documentDelete.do?documentId=' + documentId;
			  }
			}
			</script>
        </div>
