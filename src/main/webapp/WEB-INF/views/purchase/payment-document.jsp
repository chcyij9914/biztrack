					...
					<div class="mb-2">
						...
						<div class="mt-2">
							<a
								...
								class="btn btn-outline-primary btn-sm">품의서</a> <a
								href="${pageContext.request.contextPath}/purchase/payment-document.do"
								class="btn btn-primary btn-sm">지출결의서</a>
						</div>
					</div>
						...
						<div class="table-responsive">
							<table class="table table-bordered" id="purchaseTable"
								...
								<tbody class="text-center bg-white">
									<!-- 예시 데이터 반복 -->
									<c:forEach var="purchase" items="${documentList}">
										<tr>
											<td>${purchase.createdDate}</td>
											<td>${purchase.documentName}</td>
											<td>${purchase.documentId}</td>
											<td>${purchase.title}</td>
											<td>${purchase.clientName}</td>
											<td><span class="badge badge-primary">${purchase.status}</span></td>
											<td><a
