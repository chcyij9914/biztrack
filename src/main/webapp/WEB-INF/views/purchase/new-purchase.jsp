		...
		<div class="form-row mb-3">
		  <div class="col-md-6">
		    ...
		    <div class="input-group">
		      <!-- 사용자 표시용 -->
		      <input type="text" id="approver1Display" class="form-control" placeholder="1차 결재자 사번" readonly />
		      <input type="text" id="approver2Display" class="form-control" placeholder="2차 결재자 사번" readonly />
