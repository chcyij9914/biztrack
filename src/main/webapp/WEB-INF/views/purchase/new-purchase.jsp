          ...
          <div class="col-md-3">
            ...
            <input type="date" name="approve2Date" class="form-control" />
						...
						<tbody>
							<tr>
								...
								<td><input type="number" name="items[0].quantity"
									class="form-control" oninput="calculateAmount(0)"></td>
					...
					<div class="form-row mb-3">
						...
						<div class="col-md-4">
							<label>거래일자</label> <input type="date" name="documentDate"
								class="form-control" required />
						</div>
					</div>
...
$(function () {
	...
	document.addEventListener('input', function (e) {
		if (e.target && (e.target.name.endsWith('.quantity') || e.target.name.endsWith('.unitPrice'))) {
