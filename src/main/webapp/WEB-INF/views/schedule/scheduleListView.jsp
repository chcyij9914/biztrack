				...
				<div class="container-fluid">
					...
					<div
						...
						<div class="d-flex align-items-center">
							...
							<!-- 검색 필터 및 입력 -->
							<form
								action="${pageContext.request.contextPath}/schedule/SearchSchedule.do"
											...
											<tbody>
												<c:forEach var="schedule" items="${scheduleList}">
													<tr>
														...
														<td
															class="${schedule.scType eq 'PUBLIC' ? 'text-danger' : 'text-primary'}">
															<fmt:formatDate value="${schedule.startDatetime}"
																pattern="yyyy-MM-dd HH:mm" />
														</td>
														<td
															class="${schedule.scType eq 'PUBLIC' ? 'text-danger' : 'text-primary'}">
															<fmt:formatDate value="${schedule.endDatetime}"
																pattern="yyyy-MM-dd HH:mm" />
														</td>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div>
						<strong>일정 번호 :</strong> <span id="modalScId"></span>
					</div>
					<div>
						<strong>장소 :</strong> <span id="modalPlace"></span>
					</div>
					<div>
						<strong>유형 :</strong> <span id="modalType" class="badge"></span>
					</div>
					<div>
