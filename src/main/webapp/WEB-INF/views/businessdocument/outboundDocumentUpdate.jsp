    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <form action="${pageContext.request.contextPath}/businessdocument/outboundUpdate.do"
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control" name="paymentMethod">
                                            ...
                                            <option value="카드" ${document.paymentMethod == '카드' ? 'selected' : ''}>카드</option>
                            ...
                            <table class="table table-bordered text-center">
                                ...
                                <c:forEach var="item" items="${document.items}" varStatus="status">
                                    <tr>
                                        ...
                                        <td><input type="number" class="form-control text-end quantity"
                                                   name="items[${status.index}].quantity"
                                                   value="${item.quantity}" /></td>
                                        <td><input type="number" class="form-control text-end unitPrice"
                                                   name="items[${status.index}].unitPrice"
                                                   value="${item.unitPrice}" readonly /></td>
                                        <td><input type="text" class="form-control text-end amount"
                            ...
                            <c:if test="${not empty file}">
                                <p>
                                    기존 파일:
                                    <a href="${pageContext.request.contextPath}/filedown.do?fileName=${file.renameFileName}">
                            ...
                            <!-- ✅ 수정된 파일 업로드 input -->
                            <input type="file" name="uploadFiles" multiple class="form-control-file mt-2" />
