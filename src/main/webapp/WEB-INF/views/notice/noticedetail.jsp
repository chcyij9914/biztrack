						...
						<div class="card-body">
							<form
								...
								<div class="form-group">
									<label> 공지사항 번호 </label> <input type="text" class="form-control"
								...
								<div class="form-group">
									<label>중요 공지여부</label> <input type="text" class="form-control"
										name="importance" value="${notice.importance == 'Y'}" />
								</div>

								<div class="form-group">
									<label>중요 공지 종료일</label>
									<input type="date" class="form-control"
										name="impEndDate" value="${notice.impEndDate}" />							
								</div>
